...
const ChatEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'participant': PropertySchema(
      id: 2,
      name: r'participant',
      type: IsarType.object,
      target: r'UserEmbedded',
    ),
  ...
  links: {},
  embeddedSchemas: {r'UserEmbedded': UserEmbeddedSchema},
...
int _chatEntityEstimateSize(
  ...
  bytesCount += 3 +
      UserEmbeddedSchema.estimateSize(
          object.participant, allOffsets[UserEmbedded]!, allOffsets);
...
void _chatEntitySerialize(
  ...
  writer.writeObject<UserEmbedded>(
    offsets[2],
    allOffsets,
    UserEmbeddedSchema.serialize,
    object.participant,
  );
...
ChatEntity _chatEntityDeserialize(
  ...
  final object = ChatEntity(
    ...
    lastMessage: reader.readString(offsets[1]),
    senderID: reader.readString(offsets[3]),
    time: reader.readString(offsets[4]),
    unreadCount: reader.readLong(offsets[5]),
  );
  object.id = id;
  object.participant = reader.readObjectOrNull<UserEmbedded>(
        offsets[2],
        UserEmbeddedSchema.deserialize,
        allOffsets,
      ) ??
      UserEmbedded();
  return object;
...
P _chatEntityDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readString(offset)) as P;
    case 2:
      return (reader.readObjectOrNull<UserEmbedded>(
            offset,
            UserEmbeddedSchema.deserialize,
            allOffsets,
          ) ??
...
extension ChatEntityQueryFilter
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> senderIDEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> senderIDLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> senderIDBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> senderIDEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> senderIDContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> senderIDMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> timeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> timeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> timeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> timeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> timeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'time',
        value: '',
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> timeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'time',
        value: '',
...
extension ChatEntityQueryObject
    on QueryBuilder<ChatEntity, ChatEntity, QFilterCondition> {
  QueryBuilder<ChatEntity, ChatEntity, QAfterFilterCondition> participant(
      FilterQuery<UserEmbedded> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'participant');
    });
  }
}
...
extension ChatEntityQuerySortBy
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterSortBy> sortBySenderID() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderID', Sort.asc);
    });
  }

  QueryBuilder<ChatEntity, ChatEntity, QAfterSortBy> sortBySenderIDDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatEntityQuerySortThenBy
  ...
  QueryBuilder<ChatEntity, ChatEntity, QAfterSortBy> thenBySenderID() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderID', Sort.asc);
    });
  }

  QueryBuilder<ChatEntity, ChatEntity, QAfterSortBy> thenBySenderIDDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderID', Sort.desc);
    });
  }
...
extension ChatEntityQueryWhereDistinct
  ...
  QueryBuilder<ChatEntity, ChatEntity, QDistinct> distinctBySenderID(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatEntityQueryProperty
  ...
  QueryBuilder<ChatEntity, UserEmbedded, QQueryOperations>
      participantProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'participant');
    });
  }

  QueryBuilder<ChatEntity, String, QQueryOperations> senderIDProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'senderID');
    });
  }

  QueryBuilder<ChatEntity, String, QQueryOperations> timeProperty() {
    return QueryBuilder.apply(this, (query) {
...
const UserEmbeddedSchema = Schema(
  name: r'UserEmbedded',
  id: -82045020303298149,
  properties: {
  ...
  estimateSize: _userEmbeddedEstimateSize,
  serialize: _userEmbeddedSerialize,
  deserialize: _userEmbeddedDeserialize,
  deserializeProp: _userEmbeddedDeserializeProp,
);

int _userEmbeddedEstimateSize(
  UserEmbedded object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
P _userEmbeddedDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension UserEmbeddedQueryFilter
    on QueryBuilder<UserEmbedded, UserEmbedded, QFilterCondition> {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> emailEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> emailLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> emailBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> emailEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> emailContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> emailMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> nameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> userIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> userIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserEmbedded, UserEmbedded, QAfterFilterCondition> userIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension UserEmbeddedQueryObject
    on QueryBuilder<UserEmbedded, UserEmbedded, QFilterCondition> {}
